...
const RealEstateContent = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-b from-gray-50 to-white ${isRtl ? 'rtl' : 'ltr'}`}>
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/real-estate/submit">
                <Button size="lg" className="bg-white text-blue-900 hover:bg-blue-50 px-8" data-testid="button-list-property">
                  <Home className="w-5 h-5 mr-2" />
                  {t("List Your Property", "أدرج عقارك")}
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 px-8" data-testid="button-contact-sales">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 max-w-3xl mx-auto">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-blue-200 text-sm">{isRtl ? stat.label.ar : stat.label.en}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTemplates.map((template) => (
              <Card key={template.id} className="group hover:shadow-xl transition-all duration-300 border-gray-200">
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <Button className="w-full group-hover:bg-blue-600 transition-colors" data-testid={`button-template-${template.id}`}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3">{t("Sell", "بيع")}</h3>
            ...
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3">{t("Rent", "تأجير")}</h3>
              <p className="text-gray-600 mb-4">
                {t(
            ...
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3">{t("Exchange", "استبدال")}</h3>
              <p className="text-gray-600 mb-4">
                {t(
          ...
          <div className="text-center mt-12">
            <Link to="/real-estate/submit">
              <Button size="lg" className="px-10" data-testid="button-submit-property">
                <Home className="w-5 h-5 mr-2" />
